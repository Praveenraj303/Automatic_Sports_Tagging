...
<style>
    ...
    {
        body{background-size: cover;position: fixed}
    }
    #particles-js{
        height: 100%
    }
...
<script>
    ...
    if(uname.value=="praveen" && pass.value=="aac")
        {
...
<body>
    <form action="./moduledegn.py" name="login" onsubmit="return validate()">
    <div class="loginBox"> <img class="user" src="./image/logo.png" height="100px" width="100px">
        <h3>Sign in here</h3>/
